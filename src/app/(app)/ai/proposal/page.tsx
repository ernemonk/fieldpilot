...
export default function AIProposalGeneratorPage() {
  ...
  const handleGenerate = async () => {
    ...
    // Simulate AI processing (replace with Gemini API call)
...
### 2.3 Phase 3 — Testing & Commissioning
...
- Change orders will be documented and approved in writing
- All work guaranteed for 12 months from completion
- Fully licensed and insured — COI available upon request

## 7. Acceptance

By signing below, the client accepts the terms outlined in this proposal.

| | |
|---|---|
| **Client Signature** | _________________________ |
| **Date** | _________________________ |
| **Printed Name** | ${clientName || '________________________'} |
